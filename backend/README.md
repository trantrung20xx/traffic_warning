...
- OCR Paddle chạy ở process riêng (`PaddleOcrSubprocessClient`) để hạn chế xung đột CUDA với Torch trong process chính.
...
| `license_plate.paddle_subprocess_enabled` | Bật OCR subprocess. |
| `license_plate.paddle_subprocess_startup_timeout_s` | Timeout startup subprocess OCR. |
| `license_plate.paddle_subprocess_request_timeout_ms` | Timeout request OCR. |
