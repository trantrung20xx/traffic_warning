...
| `lanes[].approach_zone` | Vùng xe đi vào trước khi rẽ, dùng để khóa làn nguồn. |
| `lanes[].commit_gate` | Vùng xác nhận xe bắt đầu thực hiện hướng đi. |
| `lanes[].commit_line` | Vạch xác nhận xe bắt đầu thực hiện hướng đi. |
...
| `lanes[].allowed_maneuvers` | Hướng đi hợp lệ theo luật của làn. |
| `lanes[].maneuvers.<m>.enabled` | Bật/tắt nhận diện hướng đi này. |
| `lanes[].maneuvers.<m>.allowed` | Cho phép/cấm hướng đi này theo luật. |
| `lanes[].maneuvers.<m>.movement_path` | Đường đi kỳ vọng của xe khi thực hiện hướng này (polyline). |
...
| `lanes[].maneuvers.<m>.exit_line` | Vạch xác nhận xe đã đi ra đúng nhánh của hướng đi. |
| `lanes[].maneuvers.<m>.exit_zone` | Vùng xác nhận xe đã đi ra đúng nhánh của hướng đi. |
