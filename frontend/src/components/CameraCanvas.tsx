...
import { LanePolygon, TrackVehicle } from "../types";
...
export default function CameraCanvas({ frameWidth, frameHeight, lanes, vehicles }: Props) {
  ...
  return (
    <canvas
      ref={canvasRef}
      style={{ width: "100%", height: "auto", background: "#0b0f14", borderRadius: 10 }}
    />
  );
}
